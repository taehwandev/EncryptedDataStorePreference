...
import tech.thdev.useful.encrypted.data.store.preferences.internal.generateDefaultValue
...
import tech.thdev.useful.encrypted.data.store.preferences.internal.hasFlow
import tech.thdev.useful.encrypted.data.store.preferences.internal.mergePrefixGenerate
...
internal class GeneratePreferences(
    ...
    private fun ValueModel.Get.generateGetFunction(
        ...
        logger.writeLogger("generateGetFunction isSuspend $isSuspend")
